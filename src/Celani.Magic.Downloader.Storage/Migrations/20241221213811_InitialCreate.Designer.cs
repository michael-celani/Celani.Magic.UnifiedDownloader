...
namespace Celani.Magic.Downloader.Storage.Migrations
{
    ...
    [Migration("20241221213811_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Celani.Magic.Downloader.Storage.OracleCardStoredDeck", b =>
                {
                    b.HasOne("Celani.Magic.Downloader.Storage.OracleCard", null)
                        .WithMany()
                        .HasForeignKey("CardsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Celani.Magic.Downloader.Storage.StoredDeck", null)
